...
later. Each release ships exact pins:
    ...
    pip install "scovant-core==0.5.2" -c https://raw.githubusercontent.com/Scovant/scovant-core/v0.5.2/constraints/constraints-0.5.2.txt
...
[`docs/releasing.md`](docs/releasing.md); pin `@v0.5.2` instead for an
