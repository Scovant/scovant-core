...
later. Each release ships exact pins:
    ...
    pip install "scovant-core==0.6.0" -c https://raw.githubusercontent.com/Scovant/scovant-core/v0.6.0/constraints/constraints-0.6.0.txt
...
[`docs/releasing.md`](docs/releasing.md); pin `@v0.6.0` instead for an
