...
66 checks: 55 PASS, 1 WARN, 0 FAIL, 10 N/A, 0 ERROR
...
- **CORE-SECURITY-002** — HSTS presence (info): HSTS present with a meaningful max-age.
...
- **CORE-SECURITY-003** — Content-Security-Policy / framing policy (info): CSP present with a framing directive.
...
- **CORE-SECURITY-004** — Security-relevant cookie attributes (info): Session-like cookies carry Secure, HttpOnly and SameSite.
...
- **CORE-SECURITY-005** — Referrer / MIME hygiene headers (info): Referrer-Policy and X-Content-Type-Options: nosniff are set.
...
| Medium | 0 |
| Low | 0 |
| Web baseline | PASS 5  WARN 0  FAIL 0 |
